...
<div class="container">
	<form action="/orderProcess" class="form-horizontal">
		<fieldset>
			...
			<div class="form-group">
				<label class="col sm-4 control label" for="username">Customer Email</label>
					<div class="col sm-4">
						<label class="col sm-4 control label" for="username">${userDetails.userid}</label>
				</div>
			</div>
			
			<div class="form-group">
				<label class="col sm-4 control label" for="username">Customer Address</label>
					<div class="col sm-4">
			...
			<div class="form-group">
				<label class="col sm-4 control label" for="username">Delivery Date</label>
					<div class="col sm-4">
