	...
	<div class="container">
		<table class="table table-striped">
			<tr>
				...
				<c:url value="/resources/product/${Product.productId}.png" var="image"></c:url>
			
				<td colspan="2"><img src="${image}" height="300" width="250"/></td>
				<td class="font"><p><font color="red">Product Name</font></p>${product.productName}</td>
				<td class="font"> <p><font color="red">Price</font></p>${product.price}</td>
				<td class="font"><p><font color="red"> Description</font></p> ${product.productDesc}</td>
