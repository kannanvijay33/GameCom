		...
		<table class="table table-striped">
			...
			<tbody>
				<c:forEach items="${i.cartitems}" var="c">
					<tr>
						<c:url value="/resources/images/${c.products.productId}.png" var="image"></c:url>
						...
						<input type="text" value="${c.quantity}" style="width: 36px; text-align: center;"> <c:url
								value="/cart/plus/${c.products.productId}" var="plus"></c:url> 
								
					<a href="${plus}"><span class="glyphicon glyphicon-plus-sign">
							</span>
							</a>
					  </td>
